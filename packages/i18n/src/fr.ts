export const fr = {
  ...
  'accueil.taille': 'Fenêtre : {taille}',
  'accueil.taillePetite': 'petite',
  'accueil.tailleGrande': 'grande',
  'accueil.tailleGeante': 'géante',
  ...
  'message.habitantParti': 'Trop malheureux, un habitant quitte le village…',
  'message.constructionTerminee': '{batiment} terminé',
  'message.faim': 'Plus de baies en stock !',
  'probleme.faim': 'Plus de baies en stock',
  'probleme.malheur': 'Les habitants sont malheureux et quittent le village',
